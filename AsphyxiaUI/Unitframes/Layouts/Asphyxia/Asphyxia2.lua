...
do
	...
	------------------------------
	do
		G.UnitFrames.Player.Power:Size( 247, 2 )
		G.UnitFrames.Player.Power:ClearAllPoints()
		G.UnitFrames.Player.Power:Point( "TOPRIGHT", G.UnitFrames.Player.Health, "BOTTOMRIGHT", 7, -11 )
	...
	do
		if( C["unitframes"]["charportrait"] == true ) then
			...
			PlayerPortrait:Size( 237, 17 )
			PlayerPortrait:SetPoint( "TOP", G.UnitFrames.Player.Health, "BOTTOM", 0, -22 )
			...
			G.UnitFrames.Player.Portrait:Point( "TOPLEFT", PlayerPortrait, "TOPLEFT", 3, -2 )
	...
	do
		if( C["unitframes"]["classicons"] == true ) then
			...
			classicon:Size( 38 )
			classicon:Point( "RIGHT", G.UnitFrames.Player.Power, "LEFT", -10, 0 )
	...
	do
		if( C["unitframes"]["unitcastbar"] == true ) then
			...
			AsphyxiaUIUnitframesPlayerCastbarMover:FontString( "Text", unpack( S.FontTemplate.MoverDefault.BuildFont ) )
	...
	------------------------------
	do
		local AsphyxiaUILayout2PlayerLineLeft = CreateFrame( "Frame", "AsphyxiaUILayout2PlayerLineLeft", G.UnitFrames.Player )
		AsphyxiaUILayout2PlayerLineLeft:Size( 2, 38 )
		AsphyxiaUILayout2PlayerLineLeft:SetPoint( "RIGHT", G.UnitFrames.Player.Power, "LEFT", -5, 0 )
		AsphyxiaUILayout2PlayerLineLeft:SetTemplate( "Default" )
		AsphyxiaUILayout2PlayerLineLeft:SetFrameLevel( 2 )
		AsphyxiaUILayout2PlayerLineLeft:SetFrameStrata( "BACKGROUND" )

		local AsphyxiaUILayout2PlayerLineRight = CreateFrame( "Frame", "AsphyxiaUILayout2PlayerLineRight", G.UnitFrames.Player )
		AsphyxiaUILayout2PlayerLineRight:Size( 2, 38 )
		AsphyxiaUILayout2PlayerLineRight:SetPoint( "LEFT", G.UnitFrames.Player.Power, "RIGHT", 5, 0 )
		AsphyxiaUILayout2PlayerLineRight:SetTemplate( "Default" )
		AsphyxiaUILayout2PlayerLineRight:SetFrameLevel( 2 )
		AsphyxiaUILayout2PlayerLineRight:SetFrameStrata( "BACKGROUND" )

		local AsphyxiaUILayout2PlayerLineTop = CreateFrame( "Frame", "AsphyxiaUILayout2PlayerLineTop", G.UnitFrames.Player )
		AsphyxiaUILayout2PlayerLineTop:Size( 261, 2 )
		AsphyxiaUILayout2PlayerLineTop:SetPoint( "TOPLEFT", AsphyxiaUILayout2PlayerLineLeft, "TOPLEFT", 0, 0 )
		AsphyxiaUILayout2PlayerLineTop:SetTemplate( "Default" )
		AsphyxiaUILayout2PlayerLineTop:SetFrameLevel( 2 )
		AsphyxiaUILayout2PlayerLineTop:SetFrameStrata( "BACKGROUND" )

		local AsphyxiaUILayout2PlayerLineBottom = CreateFrame( "Frame", "AsphyxiaUILayout2PlayerLineBottom", G.UnitFrames.Player )
		AsphyxiaUILayout2PlayerLineBottom:Size( 261, 2 )
		AsphyxiaUILayout2PlayerLineBottom:SetPoint( "BOTTOMLEFT", AsphyxiaUILayout2PlayerLineLeft, "BOTTOMLEFT", 0, 0 )
		AsphyxiaUILayout2PlayerLineBottom:SetTemplate( "Default" )
		AsphyxiaUILayout2PlayerLineBottom:SetFrameLevel( 2 )
		AsphyxiaUILayout2PlayerLineBottom:SetFrameStrata( "BACKGROUND" )
	end
...
do
	...
	------------------------------
	do
		G.UnitFrames.Target.Health:Size( 233, 13 )
	...
	------------------------------
	do
		G.UnitFrames.Target.Power:Size( 247, 2 )
		G.UnitFrames.Target.Power:ClearAllPoints()
		G.UnitFrames.Target.Power:Point( "TOPRIGHT", G.UnitFrames.Target.Health, "BOTTOMRIGHT", 7, -11 )
	...
	do
		if( C["unitframes"]["charportrait"] == true ) then
			...
			TargetPortrait:Size( 237, 17 )
			TargetPortrait:SetPoint( "TOP", G.UnitFrames.Target.Health, "BOTTOM", 0, -22 )
			...
			G.UnitFrames.Target.Portrait:Point( "TOPLEFT", TargetPortrait, "TOPLEFT", 3, -2 )
	...
	do
		if( C["unitframes"]["classicons"] == true ) then
			...
			classicon:Size( 38 )
			classicon:Point( "LEFT", G.UnitFrames.Target.Power, "RIGHT", 10, 0 )
			classicon:SetTemplate( "Default" )
	...
	do
		if( C["unitframes"]["unitcastbar"] == true ) then
			...
			G.UnitFrames.Target.Castbar:Point( "TOPRIGHT", G.UnitFrames.Target, "BOTTOMRIGHT", 0, -31 )
	...
	------------------------------
	do
		local AsphyxiaUILayout2TargetLineLeft = CreateFrame( "Frame", "AsphyxiaUILayout2TargetLineLeft", G.UnitFrames.Target )
		AsphyxiaUILayout2TargetLineLeft:Size( 2, 38 )
		AsphyxiaUILayout2TargetLineLeft:SetPoint( "RIGHT", G.UnitFrames.Target.Power, "LEFT", -5, 0 )
		AsphyxiaUILayout2TargetLineLeft:SetTemplate( "Default" )
		AsphyxiaUILayout2TargetLineLeft:SetFrameLevel( 2 )
		AsphyxiaUILayout2TargetLineLeft:SetFrameStrata( "BACKGROUND" )

		local AsphyxiaUILayout2TargetLineRight = CreateFrame( "Frame", "AsphyxiaUILayout2TargetLineRight", G.UnitFrames.Target )
		AsphyxiaUILayout2TargetLineRight:Size( 2, 38 )
		AsphyxiaUILayout2TargetLineRight:SetPoint( "LEFT", G.UnitFrames.Target.Power, "RIGHT", 5, 0 )
		AsphyxiaUILayout2TargetLineRight:SetTemplate( "Default" )
		AsphyxiaUILayout2TargetLineRight:SetFrameLevel( 2 )
		AsphyxiaUILayout2TargetLineRight:SetFrameStrata( "BACKGROUND" )

		local AsphyxiaUILayout2TargetLineTop = CreateFrame( "Frame", "AsphyxiaUILayout2TargetLineTop", G.UnitFrames.Target )
		AsphyxiaUILayout2TargetLineTop:Size( 261, 2 )
		AsphyxiaUILayout2TargetLineTop:SetPoint( "TOPLEFT", AsphyxiaUILayout2TargetLineLeft, "TOPLEFT", 0, 0 )
		AsphyxiaUILayout2TargetLineTop:SetTemplate( "Default" )
		AsphyxiaUILayout2TargetLineTop:SetFrameLevel( 2 )
		AsphyxiaUILayout2TargetLineTop:SetFrameStrata( "BACKGROUND" )

		local AsphyxiaUILayout2TargetLineBottom = CreateFrame( "Frame", "AsphyxiaUILayout2TargetLineBottom", G.UnitFrames.Target )
		AsphyxiaUILayout2TargetLineBottom:Size( 261, 2 )
		AsphyxiaUILayout2TargetLineBottom:SetPoint( "BOTTOMLEFT", AsphyxiaUILayout2TargetLineLeft, "BOTTOMLEFT", 0, 0 )
		AsphyxiaUILayout2TargetLineBottom:SetTemplate( "Default" )
		AsphyxiaUILayout2TargetLineBottom:SetFrameLevel( 2 )
		AsphyxiaUILayout2TargetLineBottom:SetFrameStrata( "BACKGROUND" )
	end
...
do
	...
	do
		...
		G.UnitFrames.Focus.Name:SetFont( unpack( S.FontTemplate.UnitframesName.BuildFont ) )
		...
		G.UnitFrames.Focus.Health.value = S.SetFontString( G.UnitFrames.Focus.Health, unpack( S.FontTemplate.UnitframesHealth.BuildFont ) )
	...
	do
		...
		G.UnitFrames.Focus.Power.value = S.SetFontString( G.UnitFrames.Focus.Health, unpack( S.FontTemplate.UnitframesPower.BuildFont ) )
	...
	do
		if( C["unitframes"]["unitcastbar"] == true ) then
			...
			G.UnitFrames.Focus.Castbar.Text = S.SetFontString( G.UnitFrames.Focus.Castbar, unpack( S.FontTemplate.UnitframesDefault.BuildFont ) )
...
do
	...
	do
		...
		G.UnitFrames.FocusTarget.Name:SetFont( unpack( S.FontTemplate.UnitframesName.BuildFont ) )
		...
		G.UnitFrames.FocusTarget.Health.value = S.SetFontString( G.UnitFrames.FocusTarget.Health, unpack( S.FontTemplate.UnitframesHealth.BuildFont ) )
	...
	do
		...
		G.UnitFrames.FocusTarget.Power.value = S.SetFontString( G.UnitFrames.FocusTarget.Health, unpack( S.FontTemplate.UnitframesPower.BuildFont ) )
	...
	do
		if( C["unitframes"]["unitcastbar"] == true ) then
			...
			G.UnitFrames.FocusTarget.Castbar.Time = S.SetFontString( G.UnitFrames.FocusTarget.Castbar, unpack( S.FontTemplate.UnitframesDefault.BuildFont ) )
			...
			G.UnitFrames.FocusTarget.Castbar.Text = S.SetFontString( G.UnitFrames.FocusTarget.Castbar, unpack( S.FontTemplate.UnitframesDefault.BuildFont ) )
...
do
	for i = 1, MAX_BOSS_FRAMES do
		...
		do
			...
			G.UnitFrames["Boss" .. i].Name:SetFont( unpack( S.FontTemplate.UnitframesName.BuildFont ) )
			...
			G.UnitFrames["Boss" .. i].Health.value = S.SetFontString( G.UnitFrames["Boss" .. i].Health, unpack( S.FontTemplate.UnitframesHealth.BuildFont ) )
		...
		do
			...
			G.UnitFrames["Boss" .. i].Power.value = S.SetFontString( G.UnitFrames["Boss" .. i].Health, unpack( S.FontTemplate.UnitframesPower.BuildFont ) )
		...
		do
			if( C["unitframes"]["unitcastbar"] == true ) then
				...
				G.UnitFrames["Boss" .. i].Castbar:CreateShadow( "Default" )
				...
				G.UnitFrames["Boss" .. i].Castbar.Time = S.SetFontString( G.UnitFrames["Boss" .. i].Castbar, unpack( S.FontTemplate.UnitframesDefault.BuildFont ) )
				...
				G.UnitFrames["Boss" .. i].Castbar.Text = S.SetFontString( G.UnitFrames["Boss" .. i].Castbar, unpack( S.FontTemplate.UnitframesDefault.BuildFont ) )
	...
	if( C["unitframes"]["arena"] == true ) then
		for i = 1, 5 do
			...
			do
				...
				G.UnitFrames["Arena" .. i].Name:SetFont( unpack( S.FontTemplate.UnitframesName.BuildFont ) )
				...
				G.UnitFrames["Arena" .. i].Health.value = S.SetFontString( G.UnitFrames["Arena" .. i].Health, unpack( S.FontTemplate.UnitframesHealth.BuildFont ) )
			...
			do
				...
				G.UnitFrames["Arena" .. i].Power.value = S.SetFontString( G.UnitFrames["Arena" .. i].Health, unpack( S.FontTemplate.UnitframesPower.BuildFont ) )
			...
			do
				if( C["unitframes"]["unitcastbar"] == true ) then
					...
					G.UnitFrames["Arena" .. i].Castbar.Time = S.SetFontString( G.UnitFrames["Arena" .. i].Castbar, unpack( S.FontTemplate.UnitframesDefault.BuildFont ) )
					...
					G.UnitFrames["Arena" .. i].Castbar.Text = S.SetFontString( G.UnitFrames["Arena" .. i].Castbar, unpack( S.FontTemplate.UnitframesDefault.BuildFont ) )
...
FramePositions:SetScript( "OnEvent", function( self, event, addon )
	...
	if( IsAddOnLoaded( "AsphyxiaUI_Raid" ) ) then
		G.UnitFrames.Player:SetPoint( "TOP", UIParent, "BOTTOM", -170 , 275 )
		G.UnitFrames.Target:SetPoint( "TOP", UIParent, "BOTTOM", 170 , 275 )
	elseif( IsAddOnLoaded( "AsphyxiaUI_Raid_Healing" ) ) then
		G.UnitFrames.Player:SetPoint( "TOP", UIParent, "BOTTOM", -309 , 365 )
		G.UnitFrames.Target:SetPoint( "TOP", UIParent, "BOTTOM", 309 , 365 )
	else
		G.UnitFrames.Player:SetPoint( "TOP", UIParent, "BOTTOM", -309 , 365 )
		G.UnitFrames.Target:SetPoint( "TOP", UIParent, "BOTTOM", 309 , 365 )
	end

	G.UnitFrames.TargetTarget:SetPoint( "TOPRIGHT", G.UnitFrames.Target, "BOTTOMRIGHT", 0, -64 )
	G.UnitFrames.Pet:SetPoint( "TOPLEFT", G.UnitFrames.Player, "BOTTOMLEFT", 0, -64 )
