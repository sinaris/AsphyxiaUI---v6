...
AsphyxiaUIInstallFrameIconLeft:Point( unpack( S.SetFramePosition.Installation.LeftIcon ) )
...
AsphyxiaUIInstallFrameIconRight:Point( unpack( S.SetFramePosition.Installation.RightIcon ) )
...
AsphyxiaUIInstallFrameTitle:Point( unpack( S.SetFramePosition.Installation.Title ) )
...
AsphyxiaUIInstallFrameBottom:Point( unpack( S.SetFramePosition.Installation.Copyright ) )
