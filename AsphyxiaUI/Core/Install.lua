...
InstallFrameIconLeft:Size( 58, 58 )
InstallFrameIconLeft:Point( "BOTTOMLEFT", G.Install.Frame, "TOPLEFT", 0, 3 )
...
InstallFrameIconRight:Size( 58, 58 )
InstallFrameIconRight:Point( "BOTTOMRIGHT", G.Install.Frame, "TOPRIGHT", 0, 3 )
...
InstallFrameTitle:Size( G.Install.Frame:GetWidth( ) - 122, 30 )
InstallFrameTitle:Point( "BOTTOM", G.Install.Frame, "TOP", 0, 3 )
