...
TukuiSplitBarLeft:Size( ( S.buttonsize * 3 ) + ( S.buttonspacing * 4 ) + 2, G.ActionBars.Bar1:GetHeight() )
TukuiSplitBarLeft:Point( "BOTTOMRIGHT", G.ActionBars.Bar1, "BOTTOMLEFT", -3, 0 )
TukuiSplitBarLeft:SetTemplate( "Transparent" )
TukuiSplitBarLeft:CreateShadow( "Default" )

local TukuiSplitBarRight = CreateFrame( "Frame", "TukuiSplitBarRight", UIParent )
TukuiSplitBarRight:Size( ( S.buttonsize * 3 ) + ( S.buttonspacing * 4 ) + 2, G.ActionBars.Bar1:GetHeight() )
TukuiSplitBarRight:Point( "BOTTOMLEFT", G.ActionBars.Bar1, "BOTTOMRIGHT", 3, 0 )
TukuiSplitBarRight:SetTemplate( "Transparent" )
TukuiSplitBarRight:CreateShadow( "Default" )

local TukuiRightBar = CreateFrame( "Frame", "TukuiRightBar", UIParent )
TukuiRightBar:Size( ( S.buttonsize * 12 + S.buttonspacing * 13 ) + 2,  ( S.buttonsize * 12 + S.buttonspacing * 13 ) + 2 )
TukuiRightBar:SetTemplate( "Transparent" )
...
G.Panels.LeftChatBackground:SetFrameLevel( 0 )
...
G.Panels.RightChatBackground:SetFrameLevel( 0 )
